...
public class Presenter {
    ...
    public final String ADDRESS_ON_FILE = "src/resources/config.properties";
    private Tax tax;
    IoManager io;
    ...
    public void loadFile() throws IOException {
        properties.load(new FileReader(this.ADDRESS_ON_FILE));
        this.loadProperties();
    }
    ...
    public void modifyInitValue(byte indicator, double newInitValue) throws IOException {
        switch (indicator){
            case 1:
                ...
                properties.store(new FileWriter(this.ADDRESS_ON_FILE),"Changed of init value " + indicator);
                break;
            case 2:
    ...
    public void modifyRateRange(byte indicator,double newRate) throws IOException {
        switch (indicator){
            case 1:
                ...
                properties.store(new FileWriter(this.ADDRESS_ON_FILE),"changed of rate value " + indicator);
                break;
            case 2:
    ...
    private void modifyRateResidential(Stratum stratum, double newRate) throws IOException {
        switch (stratum){
            case STRATUM1:
                ...
                properties.store(new FileWriter(this.ADDRESS_ON_FILE),"changed of rate stratum "+ Stratum.STRATUM1.getIndicator());
                break;
            case STRATUM2:
                properties.setProperty("rateResidentialStratum2",String.valueOf(newRate));
                properties.store(new FileWriter(this.ADDRESS_ON_FILE),"changed of rate stratum " + Stratum.STRATUM2.getIndicator());
                break;
            case STRATUM3:
                properties.setProperty("rateResidentialStratum3",String.valueOf(newRate));
                properties.store(new FileWriter(this.ADDRESS_ON_FILE),"changed of rate stratum " + Stratum.STRATUM3.getIndicator());
                break;
            case STRATUM4:
                properties.setProperty("rateResidentialStratum4",String.valueOf(newRate));
                properties.store(new FileWriter(this.ADDRESS_ON_FILE),"changed of rate stratum " + Stratum.STRATUM4.getIndicator());
                break;
            case STRATUM5:
                properties.setProperty("rateResidentialStratum5",String.valueOf(newRate));
                properties.store(new FileWriter(this.ADDRESS_ON_FILE),"changed of rate stratum " + Stratum.STRATUM5.getIndicator());
                break;
            case STRATUM6:
                properties.setProperty("rateResidentialStratum6",String.valueOf(newRate));
                properties.store(new FileWriter(this.ADDRESS_ON_FILE),"changed of rate stratum " + Stratum.STRATUM6.getIndicator());
                break;
        }
    }
